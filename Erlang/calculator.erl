...
% To run, enter the Erlang interpreter by entering erl into the terminal
% Then type c(calculator). to compile the program
% Then type calculator:start(). to run it
